...
import '../lib/firebase_todos_repository.dart';
import '../lib/firebase_user_repository.dart';
...
main() {
  ...
  group('FirebaseReactiveTodosRepository', () {
    test('should send todos to firestore', () {
      ...
      final repository = FirebaseTodosRepository(firestore);
      final todo = TodoEntity('A', '1', '', true);

      when(firestore.collection(FirebaseTodosRepository.path))
