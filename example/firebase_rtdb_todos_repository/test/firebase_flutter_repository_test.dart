...
import 'package:firebase_rtdb_todos_repository/firebase_rtdb_todos_repository.dart';
...
main() {
  ...
  group('FirebaseDatabaseTodosRepository', () {
    test('should send todos to firebase database', () {
      ...
      final repository = FirebaseDatabaseTodosRepository(firebaseDatabase);
      final todo = TodoEntity('A', '1', '', true);

      when(firebaseDatabase.reference()).thenReturn(reference);
      when(reference.child(FirebaseDatabaseTodosRepository.path))
